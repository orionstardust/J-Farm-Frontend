        ...
        <List>
          ...
          <Collapse in={MoreOpen} timeout="auto" unmountOnExit>
            ...
            >
              ...
              >
                <ListItemIcon className={classes.icons}>
                  <svg className="sc-bdfBwQ lmbBdH MuiSvgIcon-root"   xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240">
                    <defs>
              ...
              >
                <ListItemIcon className={classes.icons}>
                  <svg className="sc-bdfBwQ lmbBdH MuiSvgIcon-root"
                       data-name="Layer 1" id="Layer_1" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
                    <title/>
                    <path style={{
                      fill:"#564f4f"
                    }}
